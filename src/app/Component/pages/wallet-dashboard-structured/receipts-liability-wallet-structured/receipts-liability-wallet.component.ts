...
@Component({
  selector: 'app-receipts-liability-wallet', 
  templateUrl: './receipts-liability-wallet.component.html',
  styleUrl: './receipts-liability-wallet.component.scss'
})
export class ReceiptsLiabilityWalletStructuredComponent {
