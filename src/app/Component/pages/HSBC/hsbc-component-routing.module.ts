...
const routes: Routes = [
  ...
  { path: 'Bulk-Upload', component: BulkUploadPablComponent, data: { title: 'HSBC - Bulk Upload' }, canActivate: [], },
  ...
  { path: 'apiAuditLog', component: HSBCAPIAuditLogComponent, data: { title: 'HSBC - API Audit Log' }, canActivate: [], },
  { path: 'trailLog', component: HSBCTrailLogComponent, data: { title: 'HSBC - Trail Log' }, canActivate: [], },
  { path: 'thankyou', component: RMThankyouDetailsComponent, data: { title: 'HSBC - RM Assisted Journey - Thankyou' }, canActivate: [], },
  ...
  { path: 'rmExisitingPortfolio', component: RmExisitingPortfolioComponent, data: { title: 'HSBC - RM Assisted Journey - Exisiting Portfolio Details'}, canActivate: [] },
  { path: 'rmExisitingPortfolioOld', component: RmExisitingPortfolioComponent, data: { title: 'HSBC - RM Assisted Journey - Exisiting Portfolio Details' ,isNewFilter:false  }, canActivate: [] },
  { path: 'rmExisitingPortfolioView', component: RmExisitingPortfolioViewComponent, data: { title: 'HSBC - RM Assisted Journey - Exisiting Portfolio View Details' }, canActivate: [] },
  { path: 'rmTargetsProspects', component: TargetsProspectsComponent, data: { title: 'HSBC - RM Assisted Journey - Targets & Prospects' }, canActivate: [] },
  { path: 'rmTargetsProspectsOld', component: TargetsProspectsComponent, data: { title: 'HSBC - RM Assisted Journey - Targets & Prospects',isNewFilter:false }, canActivate: [] },
  { path: 'rmTargetsProspectsFind', component: TargetsProspectsFindComponent, data: { title: 'HSBC - RM Assisted Journey - Targets & Prospects Find'}, canActivate: [] },
  { path: 'rmTargetsProspectsFindOld', component: TargetsProspectsFindComponent, data: { title: 'HSBC - RM Assisted Journey - Targets & Prospects Find' ,isNewFilter:false }, canActivate: [] },
  { path: 'rmTargetsProspectsDetails', component: TargetsProspectsDetailsComponent, data: { title: 'HSBC - RM Assisted Journey - Targets & Prospects Details' }, canActivate: [] },
  { path: 'rmBankStatementAnalysis', component: RMBankStatementAnalysisComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmBankStatementUpload/:pan', component: RmBankstatementUploadComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmBankStatementAnalysisView/:bsId', component: RmBankstatementanalysisViewComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },

  { path: 'rmGSTAnalysis', component: RMGSTAnalysisComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmGSTAnalysisView', component: RMGSTAnalysisViewComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },

  { path: 'rmEXIMAnalysis', component: RMEXIMAnalysisComponent, data: { title: 'HSBC - RM Assisted Journey - EXIM Analysis Details' }, canActivate: [] },
  { path: 'rmEXIMAnalysisView', component: RMEXIMAnalysisViewComponent, data: { title: 'HSBC - RM Assisted Journey - EXIM Analysis View Details' }, canActivate: [] },
  { path: 'rmCommercialBureau', component: CommercialBureauComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },
  { path: 'rmCommercialBureauDetails', component: CommercialBureauDetailsComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },
  { path: 'rmConsumerBureau', component: ConsumerBureauComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },
  { path: 'rmConsumerBureauDetail', component: ConsumerBureauDetailsComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },
  { path: 'rmBankStatementAnalysis', component: RMBankStatementAnalysisComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmBankStatementUpload/:pan', component: RmBankstatementUploadComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmBankStatementAnalysisView/:bsId', component: RmBankstatementanalysisViewComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'rmApiAuditLogs', component: RmAPIAuditLogsComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis View Details' }, canActivate: [] },
  { path: 'findprospectstable', component: FindProspectsTableComponent, data: { title: 'HSBC - ' }, canActivate: [] },


  { path: 'investeeCompanyDetails', component: InvesteeCompanyDetailsComponent, data: { title: 'HSBC -Investee Company Details' }, canActivate: [] },
  ...
  { path: 'country-master-bulk-upload', component: CountryMasterBulkUploadComponent, data: { title: 'HSBC - Country Master Bulk Upload' }, canActivate: [], },
  ...
  { path: 'newRmBankStatementAnalysis', component: NewRMBankStatementAnalysisComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'newRmBankStatementAnalysisView/:bsId', component: NewRmBankstatementanalysisViewComponent, data: { title: 'HSBC - RM Assisted Journey - Bureau Analysis Details' }, canActivate: [] },
  { path: 'exim-external-data-upload', component: EximExternalDataUploadComponent, data: { title: 'HSBC - Exim External Data' }},
  { path: 'hsn-bulk-data-upload', component: HsnBulkDataUploadComponent, data: { title: 'HSBC - HSN Bulk Data Upload' }},
  { path: 'income-data-upload', component: IncomeDataUploadComponent, data: { title: 'HSBC - Income Data Upload' }, canActivate: []},
  { path: 'income-dashboard', component: IncomeDashboardComponent, data: { title: 'HSBC - Income Dashboard' }},
  { path: 'exim-exchange-rate-upload', component: EximExchangeRateUploadComponent, data: { title: 'HSBC - Exim Exchange Rate Upload' } },
  { path: 'exim-internal-bulk-upload', component: EximInternalBulkUploadComponent, data: { title: 'HSBC - Exim Internal Bulk Upload' } },
  { path: 'notification-configuration', component: NotificationDashboardComponent, data: { title: 'HSBC - Notification Dashboard' } },
  { path: 'commercial-crif-pr-data', component: CrifDataUploadComponent, data: { title: 'HSBC - Commercial CRIF PR Data ' }, canActivate: []},
  { path: 'help-and-support', component: HelpAndSupportComponent, data: { title: 'HSBC - Help And Support' } },
  { path: 'customer-processing-overview', component: CustomerProcessingOverviewComponent, data: { title: 'HSBC - Customer Processing Overview' } },
  { path: 'hsbc-facility-file', component: HsbcFacilityFileComponent, data: { title: 'HSBC - Facility File' } },
  // { path: 'crif-commercail-pr-data', component: CrifCommercailPrDataComponent, data: { title: 'HSBC - Crif Commercial PR Data' } },
  { path: 'my-portfolio', component: MyPortfolioComponent, data: { title: 'HSBC - My Portfolio' } },
  { path: 'crilic-data-fetch-processing', component: CrilicDataFetchProcessingComponent, data: { title: 'HSBC - Crilc Data Fetch Processing' } },
  { path: 'crilic-data-upload', component: CrilicDataUploadComponent, data: { title: 'HSBC - Crilc Data Upload' } },
  { path: 'my-saved-articles', component: MySavedArticlesComponent, data: { title: 'HSBC - My Saved Articles' } },
  { path: 'liquidity-opportunity-dashboard', component: LiquidityOpportunityDashboardComponent, data: { title: 'HSBC - Liquidity Opportunity Dashboard' } },
  { path: 'foreign-currency-transactions', component: ForeignCurrencyTransactionsComponent, data: { title: 'HSBC - Foreign Currency Transactions' } },
];
