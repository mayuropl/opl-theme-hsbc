...
@Component({
  selector: 'app-custom-dateheader', 
  templateUrl: './custom-dateheader.component.html',
  styleUrl: './custom-dateheader.component.scss'
})
export class CustomDateheaderComponent<D> implements OnDestroy {
