...
const routes: Routes = [
    { path: 'hsbc/walllet-dashboard', component: WalletDashboardComponent ,data: { title: 'Wallet Dashboard' } },
    { path: 'hsbc/pr-reconcilation-dashboard', component: PrReconcilationDashboardComponent ,data: { title: 'PR Reconcilation Dashboard' } },
];
