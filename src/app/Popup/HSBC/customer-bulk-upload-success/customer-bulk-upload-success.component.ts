...
@Component({
  selector: 'app-customer-bulk-upload-success',
  templateUrl: './customer-bulk-upload-success.component.html',
  styleUrl: './customer-bulk-upload-success.component.scss'
})
export class CustomerBulkUploadSuccessComponent implements OnInit {
  constructor(
