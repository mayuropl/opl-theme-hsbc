...
@Component({
  selector: 'app-pre-screen-bulk-upload-success',
  templateUrl: './pre-screen-bulk-upload-success.component.html',
  styleUrl: './pre-screen-bulk-upload-success.component.scss'
})
export class PreScreenBulkUploadSuccessComponent {
  constructor(
