...
export class ComparisonAnalysisPopupComponent implements OnInit{
  ...
  searchViewBySelection: any[] = [];
  searchViewByOptions: any[] = [];
  pageSize = 5;
  page = 1;
  pageSizeF = 5;
  pageF = 1;  
  ...
  protected readonly consValue = Constants;
    ...
    private dialogRef: MatDialogRef<ComparisonAnalysisPopupComponent>, public msmeService: MsmeService, 
  ...
  ngOnInit() {
    ...
    this.filtersffCFirstLevel = this.data?.filtersffCFirstLevel;
    this.searchViewBySelection = this.data?.searchViewBySelection || [];
    this.searchViewByOptions = this.data?.searchViewByOptions || [];
        ...
        if (response) {
          if (response && response.data) {
              ...
              if (this.filtersffCFirstLevel) {
                ...
                if (this.filtersffCFirstLevel.bureau_type !== undefined) {
                  this.commonService.setStorage("pr_dashboard_bureau_type", this.filtersffCFirstLevel.bureau_type.toString());
                }
                if (this.filtersffCFirstLevel.customer_type !== undefined) {
                  this.commonService.setStorage("pr_dashboard_customer_type", this.filtersffCFirstLevel.customer_type.toString());
                }
              }
              // Save Search View By second dropdown selection (e.g., Bank Line selection)
              console.log("this.searchViewBySelection",this.searchViewBySelection);
  ...
  onFetchThirdLevelView(thirdLevelReq: any) {
    ...
    this.filtersffCFour = {
      ...this.filtersffC,
      group_by_column: 'cust.cust_name',
  ...
  toggleSort(sortField: string, direction: 'ASC' | 'DESC', isThirdLevel: boolean = true) {
    const currentSortObj = isThirdLevel ? this.thirdLevelSortOrderObj : this.fourthLevelSortOrderObj;
